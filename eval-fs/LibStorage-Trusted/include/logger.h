#ifndef TFS_LOGGER_H_
#define TFS_LOGGER_H_
...
#define RELATIVE_PATH() "libtrusted/" __FILE__
...
#define LOG(level, format, ...)                                                \
    do {                                                                       \
        if (level >= CURRENT_LOG_LEVEL) {                                      \
            ...
            printf("[LibTrusted]%s%d[%s] [%s:%d]: " format "%s\n", color,      \
...
#define ERR_DEBUG(format, ...)                                                 \
    do {                                                                       \
        if (CURRENT_LOG_LEVEL == LOG_LEVEL_DEBUG) {                            \
            fprintf(stderr, "[LibTrusted][STDERR] [%s:%d]" format "\n",        \
