...
static inline bool sufs_libfs_cmpxch_bool(bool *ptr, bool expected,
                                          bool desired) {
...
static inline bool sufs_libfs_cmpxch_fdinfo(struct sufs_libfs_fdinfo *ptr,
                                            struct sufs_libfs_fdinfo expected,
                                            struct sufs_libfs_fdinfo desired) {
    return __atomic_compare_exchange_n(&(ptr->data_), &(expected.data_),
                                       desired.data_, 1, __ATOMIC_SEQ_CST,
                                       __ATOMIC_SEQ_CST);
}
