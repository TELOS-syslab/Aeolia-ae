...
static inline void sufs_libfs_fdinfo_init(struct sufs_libfs_fdinfo *info,
    ...
    info->data_ =
        ((uintptr_t)fp | (uintptr_t)cloexec | ((uintptr_t)locked << 1));
}
...
static inline bool
sufs_libfs_fdinfo_get_locked(struct sufs_libfs_fdinfo *info) {
    return (info->data_ & 2);
}

static inline struct sufs_libfs_fdinfo
sufs_libfs_fdinfo_with_locked(struct sufs_libfs_fdinfo *info, bool locked) {
...
struct sufs_libfs_fdinfo
sufs_libfs_filetable_lock_fdinfo(struct sufs_libfs_fdinfo *infop);
...
int sufs_libfs_filetable_allocfd(struct sufs_libfs_filetable *ft,
                                 struct sufs_libfs_file_mnode *f, bool percpu,
                                 bool cloexec);
