...
extern atomic_char *sufs_libfs_inode_has_mapped;
...
// OK
static inline struct sufs_libfs_mnode *
sufs_libfs_namei(struct sufs_libfs_mnode *cwd, char *path) {
...
// OK
static inline struct sufs_libfs_mnode *
sufs_libfs_nameiparent(struct sufs_libfs_mnode *cwd, char *path, char *buf) {
...
#endif
    // return ((sufs_libfs_bm_test_bit(sufs_libfs_inode_has_mapped, m->ino_num) &&
...
static inline int sufs_libfs_file_mapped_writable(struct sufs_libfs_mnode *m) {
    return (sufs_libfs_bm_test_bit(sufs_libfs_inode_mapped_attr, m->ino_num));
}
...
void sufs_libfs_flush_file_index(struct sufs_libfs_mnode *m,
                                 struct sufs_fidx_entry *start,
