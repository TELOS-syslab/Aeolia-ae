...
static inline struct sufs_libfs_range_node *sufs_libfs_alloc_range_node(void) {
    struct sufs_libfs_range_node *p;

    p = (struct sufs_libfs_range_node *)calloc(
        1, sizeof(struct sufs_libfs_range_node));

    return p;
}

static inline void
sufs_libfs_free_range_node(struct sufs_libfs_range_node *node) {
    free(node);
}

static inline struct sufs_libfs_range_node *sufs_libfs_alloc_blocknode(void) {
...
static inline struct sufs_libfs_range_node *sufs_libfs_alloc_inode_node(void) {
    return sufs_libfs_alloc_range_node();
}

static inline void
sufs_libfs_free_inode_node(struct sufs_libfs_range_node *node) {
    sufs_libfs_free_range_node(node);
}

static inline int
sufs_libfs_rbtree_compare_range_node(struct sufs_libfs_range_node *curr,
...
int sufs_libfs_rbtree_find_range_node(struct rb_root *tree, unsigned long key,
                                      enum node_type type,
                                      struct sufs_libfs_range_node **ret_node);
