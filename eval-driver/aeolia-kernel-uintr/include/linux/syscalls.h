...
/* x86 */
asmlinkage long sys_uintr_register_nvme_handler(u64 __user *handler, u32 __user irq);
asmlinkage long sys_uintr_register_uinv_handler(u64 __user *handler, u8 __user uinv);
asmlinkage long sys_uintr_send_uinv_test(u8 __user uinv);
