...
#define __NR_uintr_register_nvme_handler 471
__SYSCALL(__NR_uintr_register_nvme_handler, sys_uintr_register_nvme_handler)
#define __NR_uintr_register_uinv_handler 472
__SYSCALL(__NR_uintr_register_uinv_handler, sys_uintr_register_uinv_handler)
#define __NR_sys_uintr_send_uinv_test 473
__SYSCALL(__NR_sys_uintr_send_uinv_test, sys_uintr_send_uinv_test)
